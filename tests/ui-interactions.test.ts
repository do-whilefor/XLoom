...
describe("TUI layout and input history", () => {
  ...
  it.each([[8, 5], [9, 5], [10, 6], [24, 6]])("keeps two header spacers when they fit and flush-left text at %i rows", (height, firstTranscriptRow) => {
    ...
    expect(app.editor.getPaddingX()).toBe(0);
  });
