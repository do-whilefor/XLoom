import type { AgentToolResult } from "../../../../agent/index.js";
import {
	Box,
	type Component,
	Container,
...
import type { ToolRenderContext, ToolRenderResultOptions } from "../../../core/tools/renderers/types.js";
import { readRenderers } from "../../../core/tools/renderers/read.js";
import { writeRenderers } from "../../../core/tools/renderers/write.js";
import { editRenderers } from "../../../core/tools/renderers/edit.js";
import { createShellRenderers } from "../../../core/tools/renderers/bash.js";
const builtinRenderers = { read: readRenderers, write: writeRenderers, edit: editRenderers, bash: createShellRenderers("$") };
...
export class ToolExecutionComponent extends Container {
	...
	constructor(
		...
		this.args = args;
		this.toolDefinition = builtinRenderers[toolName as keyof typeof builtinRenderers];
    ...
    dispose(): void {
        if (this.rendererState.interval) clearInterval(this.rendererState.interval);
