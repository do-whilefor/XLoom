...
export interface Usage {
    available?: Array<"input" | "output" | "cacheRead" | "cacheWrite" | "totalTokens" | "reasoning">;
	/** XLoom: false when no verified price is available; zero numeric costs are then placeholders. */
...
export interface AssistantMessage {
    /** XLoom request-local identity, independent of provider response IDs. */
    xloomResponseId?: string;
    /** Effective user thinking setting; "default" means provider default behavior. */
    thinking?: string;
    usageAvailable?: boolean;
    usageComplete?: boolean;
    /** Native Responses items for same-model stateless replay, never rendered as text. */
    providerData?: { type: "openai-responses"; output: JsonValue[] };
	role: "assistant";
